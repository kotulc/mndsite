...
module.exports = {
  ...
  release: "0.3.0",
  display: {"crumbs":["home","path"],"header":["date","reading_time","version","status","facets"],"toc":["description","sections","related","edit"],"navbar":["theme","feed","github"],"sidebar":[{"id":"version","label":"Versions","facets":["version","status"]},{"id":"tags","label":"Tags","facets":["tags","categories"]}],"contents":["description","sections","related"]},
